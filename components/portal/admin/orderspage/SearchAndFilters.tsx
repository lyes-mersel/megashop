    ...
    <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full">
      <form onSubmit={handleSearchSubmit} className="relative w-full">
        <input
          ...
          placeholder="Rechercher par ID, nom, prénom ou produit..."
      ...
      <div className="relative w-full sm:w-32" ref={dateDropdownRef}>
        <button
          onClick={(e) => {
            ...
            if (isStatusOpen) toggleStatusDropdown();
          }}
      ...
      {/* Filtre Statut */}
      <div className="relative w-full sm:w-32" ref={statusDropdownRef}>
        <button
          onClick={(e) => {
            e.stopPropagation();
            toggleStatusDropdown();
          ...
          {isStatusOpen && (
            ...
            >
              <button
                ...
                className={`w-full px-4 py-2 text-gray-800 text-sm hover:bg-gray-100 transition-all duration-200 ${
                  !sortConfig?.key || sortConfig?.key !== "statut"
                    ? "bg-blue-50"
                    : ""
                }`}
              >
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handleSort("statut", "asc");
                  toggleStatusDropdown();
                }}
                className={`w-full px-4 py-2 text-gray-800 text-sm hover:bg-gray-100 transition-all duration-200 ${
                  sortConfig?.key === "statut" && sortConfig.direction === "asc"
                    ? "bg-blue-50"
                    : ""
                }`}
              >
