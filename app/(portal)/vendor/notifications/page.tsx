...
import NotificationList from "@/components/portal/vendor/notificationpage/NotificationList";
import NotificationFilters from "@/components/portal/vendor/notificationpage/NotificationFilters";
import NotificationActions from "@/components/portal/vendor/notificationpage/NotificationActions";
import DeleteAllModal from "@/components/portal/vendor/notificationpage/DeleteAllModal";
import Pagination from "@/components/portal/vendor/notificationpage/Pagination";
...
export default function NotificationsPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-gray-50 to-gray-200 py-6 px-4 sm:pl-10 sm:pr-10 flex flex-col">
